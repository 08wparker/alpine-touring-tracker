...
const OrtlerMap = dynamic(() => import('@/components/OrtlerMap'), {
  ssr: false,
...
export default function Ortler() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        <TripManager region="ortler" onTripLoaded={setActiveTrip} />
        <PhotoUpload
